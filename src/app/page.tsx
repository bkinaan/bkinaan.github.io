    ...
    return (
        ...
        <Head>
            ...
            <main className="flex min-h-screen flex-col items-center justify-between bg-black">
                <Top />
                <div className="text-black bg-white text-2xl md:text-4xl px-1 mb-4 md:p-2 mt-36 rounded-lg font-ss3 font-semibold text-center z-10">Hello, there! I&apos;m...</div>
                <div className='pb-10'>
                ...
                <a href='https://github.com/bkinaan/bkinaan.github.io' target="_blank">
                    <div className='text-white p-2 mt-5 border-2 rounded-md shadow-md shadow-white hover:translate-y-2 hover:shadow-sm hover:shadow-white hover:text-black hover:bg-white transition duration-300 ease-in-out'>Made by Brandon Kinaan | Code on GitHub</div>
                </a>
