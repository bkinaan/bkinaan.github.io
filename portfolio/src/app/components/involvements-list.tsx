...
export default function Involvements() {
    ...
    <div className="mb-10 pt-36">
            ...
            <div className="grid grid-cols-2 gap-7">
                <Experience role={cmfk.role} company={cmfk.company} time={cmfk.time} description={cmfk.description} link={cmfk.link}/>
                <Experience role={mlp.role} company={mlp.company} time={mlp.time} description={mlp.description} link={mlp.link}/>
                <Experience role={pase.role} company={pase.company} time={pase.time} description={pase.description} link={pase.link}/>
            </div>
    </div>
    );
}