...
export default function Experiences() {
    ...
    <div className="mb-10 pt-36">
            ...
            <div className="grid grid-cols-2 gap-7">
                <Experience role={sk.role} company={sk.company} time={sk.time} description={sk.description} link={sk.link}/>
                <Experience role={library.role} company={library.company} time={library.time} description={library.description} link={library.link}/>
            </div>
    </div>
    );
}