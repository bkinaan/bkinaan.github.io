export default function Top() {
    return(
        <div className="fixed top-0 right-0 z-50 pr-5 pt-5">
            ...
            <button className="bg-white rounded-full w-20 mb-4 max-w-md shadow-md shadow-slate-100 hover:translate-y-1 hover:shadow-sm hover:shadow-slate-100 transition duration-300 ease-in-out">
